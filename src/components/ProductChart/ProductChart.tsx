...
import LineChart from '../LineChart/LineChart'; // Adjust import path as needed
...
const ProductChart: React.FC<ProductChartProps> = ({ product }) => {
  const [period, setPeriod] = useState<'last12Months' | 'last6Months' | 'last3Months' | 'lastMonth'>('last12Months');
